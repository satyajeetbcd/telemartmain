...
<div class="max-w-7xl mx-auto space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Manage Your Availability</h2>
            <p class="text-gray-600 mt-1">Set your daily and weekly appointment time slots. Only these slots will be available for patients to book.</p>
        </div>
    ...
    <div class="bg-white border rounded-lg p-6 shadow">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Weekly Recurring Availability</h3>
    ...
    <div class="bg-white border rounded-lg p-6 shadow">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Specific Date Availability</h3>
